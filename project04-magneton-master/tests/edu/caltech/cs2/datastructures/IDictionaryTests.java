...
public interface IDictionaryTests {
    ...
    // e.g. IDictionary<K extends Comparable, V>, or IDictionary<K extends Iterable, V>
    ...
    default void iDictionarySanityTestHelper(Map<Object, Object> base, boolean testRemove) {
        ...
        for (Object k : base.keySet()) {
            ...
            assertEquals(base.get(k), impl.put(k, base.get(k)), "Putting an existing key " + k + " returns an incorrect value");
        ...
        MatcherAssert.assertThat("keySet", impl.keySet(),
